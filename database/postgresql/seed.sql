...
-- Exam 1 / Section A
('e0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'q-11111111-1111-1111-1111-111111111111', 1, 1, 5.00),
('e0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'q-22222222-2222-2222-2222-222222222222', 1, 2, 5.00),
('e0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'q-33333333-3333-3333-3333-333333333333', 1, 3, 5.00),
-- Exam 1 / Section B
('e0000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000002', 'q-44444444-4444-4444-4444-444444444444', 1, 1, 10.00),
('e0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000002', 'q-55555555-5555-5555-5555-555555555555', 1, 2, 10.00),
-- Exam 2
('e0000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000003', 'q-66666666-6666-6666-6666-666666666666', 1, 1, 5.00),
('e0000000-0000-0000-0000-000000000007', 'c0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000003', 'q-77777777-7777-7777-7777-777777777777', 1, 2, 5.00);
...
-- Attempt 1 (đạt)
('f0000000-0000-0000-0000-000000000001', 'q-11111111-1111-1111-1111-111111111111', 'e0000000-0000-0000-0000-000000000001',
    '{"selected_options":["opt_b"]}'::jsonb, true,  5.00, 45),
('f0000000-0000-0000-0000-000000000001', 'q-22222222-2222-2222-2222-222222222222', 'e0000000-0000-0000-0000-000000000002',
    '{"selected_options":["opt_a","opt_c"]}'::jsonb, true, 5.00, 60),
('f0000000-0000-0000-0000-000000000001', 'q-33333333-3333-3333-3333-333333333333', 'e0000000-0000-0000-0000-000000000003',
    '{"text":"Merge Sort"}'::jsonb, true, 5.00, 30),
('f0000000-0000-0000-0000-000000000001', 'q-44444444-4444-4444-4444-444444444444', 'e0000000-0000-0000-0000-000000000004',
    '{"order":["item_3","item_1","item_2"]}'::jsonb, true, 10.00, 120),
('f0000000-0000-0000-0000-000000000001', 'q-55555555-5555-5555-5555-555555555555', 'e0000000-0000-0000-0000-000000000005',
    '{"language":"python","code":"def bubble_sort(arr): ..."}'::jsonb, false, 0.00, 300),
-- Attempt 2 (không đạt)
('f0000000-0000-0000-0000-000000000002', 'q-11111111-1111-1111-1111-111111111111', 'e0000000-0000-0000-0000-000000000001',
    '{"selected_options":["opt_a"]}'::jsonb, false, 0.00, 50),
('f0000000-0000-0000-0000-000000000002', 'q-22222222-2222-2222-2222-222222222222', 'e0000000-0000-0000-0000-000000000002',
    '{"selected_options":["opt_b"]}'::jsonb, false, 0.00, 40),
-- Attempt 3 (đang làm, 1 câu đã trả lời)
('f0000000-0000-0000-0000-000000000003', 'q-66666666-6666-6666-6666-666666666666', 'e0000000-0000-0000-0000-000000000006',
...
('aaaa0001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111',
    ...
    '{"questions_generated":5,"question_ids":["q-aaa1","q-aaa2","q-aaa3","q-aaa4","q-aaa5"]}'::jsonb,
...
('aaaa0002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111',
    ...
    '{"attempt_id":"f0000000-0000-0000-0000-000000000001","question_ref_id":"q-77777777-7777-7777-7777-777777777777"}'::jsonb,
